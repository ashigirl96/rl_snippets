...
for i_episode in range(FLAGS.episodes):
    ...
    for t in itertools.count():
        ...
        # Sarsa
        td_target = reward + FLAGS.discounter * Q[next_state][next_action]
    ...
    # if all_episode_reward.mean() < FLAGS.goal_reward:
    #     print("Episode {0} train agent successfuly".format(i_episode))
    #     break
